...
public class MMuxFS extends AbstractFileSystem {
  private MMuxFileSystem dfs;

  public MMuxFS(final URI uri, final Configuration conf) throws IOException, URISyntaxException {
    super(uri, "mmfs", true, 9090);
    this.dfs = new MMuxFileSystem();
