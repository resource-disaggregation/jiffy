...
class auto_scaling_service_auto_scaling_result {
 public:
  ...
  bool operator < (const auto_scaling_service_auto_scaling_result & ) const;
...
class auto_scaling_service_auto_scaling_presult {
 public:
