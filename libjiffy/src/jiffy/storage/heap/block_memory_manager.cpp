...
block_memory_manager::block_memory_manager(size_t capacity, std::string memory_mode, void *mem_kind)
    : capacity_(capacity), used_(0), memory_mode_(std::move(memory_mode)), mem_kind_(mem_kind) {
}
