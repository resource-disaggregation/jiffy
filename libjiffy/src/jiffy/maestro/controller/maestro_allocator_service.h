...
class maestro_allocator_serviceIf {
 public:
  ...
  virtual void allocate(std::vector<std::string> & _return, const std::string& tenantID, const int64_t numBlocks) = 0;
  virtual void deallocate(const std::string& tenentID, const std::vector<std::string> & blocks) = 0;
};
...
class maestro_allocator_serviceIfSingletonFactory : virtual public maestro_allocator_serviceIfFactory {
 public:
  maestro_allocator_serviceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<maestro_allocator_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<maestro_allocator_serviceIf> iface_;
};

class maestro_allocator_serviceNull : virtual public maestro_allocator_serviceIf {
 public:
  virtual ~maestro_allocator_serviceNull() {}
  void allocate(std::vector<std::string> & /* _return */, const std::string& /* tenantID */, const int64_t /* numBlocks */) {
    return;
  }
...
class maestro_allocator_service_allocate_args {
 public:
  ...
  virtual ~maestro_allocator_service_allocate_args() throw();
  std::string tenantID;
  int64_t numBlocks;
...
class maestro_allocator_service_allocate_pargs {
 public:
  ...
  virtual ~maestro_allocator_service_allocate_pargs() throw();
...
class maestro_allocator_service_allocate_result {
 public:
  ...
  virtual ~maestro_allocator_service_allocate_result() throw();
...
class maestro_allocator_service_allocate_presult {
 public:
  ...
  virtual ~maestro_allocator_service_allocate_presult() throw();
  std::vector<std::string> * success;
  maestro_allocator_service_exception ex;
...
class maestro_allocator_service_deallocate_args {
 public:
  ...
  virtual ~maestro_allocator_service_deallocate_args() throw();
  std::string tenentID;
  ...
  void __set_blocks(const std::vector<std::string> & val);
...
class maestro_allocator_service_deallocate_pargs {
 public:
  ...
  virtual ~maestro_allocator_service_deallocate_pargs() throw();
...
class maestro_allocator_service_deallocate_result {
 public:
  ...
  virtual ~maestro_allocator_service_deallocate_result() throw();
  maestro_allocator_service_exception ex;
...
class maestro_allocator_service_deallocate_presult {
 public:
  ...
  virtual ~maestro_allocator_service_deallocate_presult() throw();
  maestro_allocator_service_exception ex;
...
class maestro_allocator_serviceClientT : virtual public maestro_allocator_serviceIf {
 public:
  maestro_allocator_serviceClientT(apache::thrift::stdcxx::shared_ptr< Protocol_> prot) {
    setProtocolT(prot);
  }
  maestro_allocator_serviceClientT(apache::thrift::stdcxx::shared_ptr< Protocol_> iprot, apache::thrift::stdcxx::shared_ptr< Protocol_> oprot) {
 ...
 public:
  ...
  void recv_allocate(std::vector<std::string> & _return);
  void deallocate(const std::string& tenentID, const std::vector<std::string> & blocks);
  void send_deallocate(const std::string& tenentID, const std::vector<std::string> & blocks);
...
class maestro_allocator_serviceProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 public:
  maestro_allocator_serviceProcessorT(::apache::thrift::stdcxx::shared_ptr<maestro_allocator_serviceIf> iface) :
    iface_(iface) {
...
class maestro_allocator_serviceProcessorFactoryT : public ::apache::thrift::TProcessorFactory {
 public:
  maestro_allocator_serviceProcessorFactoryT(const ::apache::thrift::stdcxx::shared_ptr< maestro_allocator_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< maestro_allocator_serviceIfFactory > handlerFactory_;
};
...
class maestro_allocator_serviceMultiface : virtual public maestro_allocator_serviceIf {
 public:
  maestro_allocator_serviceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<maestro_allocator_serviceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~maestro_allocator_serviceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<maestro_allocator_serviceIf> > ifaces_;
  maestro_allocator_serviceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<maestro_allocator_serviceIf> iface) {
...
class maestro_allocator_serviceConcurrentClientT : virtual public maestro_allocator_serviceIf {
 public:
  maestro_allocator_serviceConcurrentClientT(apache::thrift::stdcxx::shared_ptr< Protocol_> prot) {
    setProtocolT(prot);
  }
  maestro_allocator_serviceConcurrentClientT(apache::thrift::stdcxx::shared_ptr< Protocol_> iprot, apache::thrift::stdcxx::shared_ptr< Protocol_> oprot) {
    setProtocolT(iprot,oprot);
  }
 private:
  void setProtocolT(apache::thrift::stdcxx::shared_ptr< Protocol_> prot) {
 ...
 public:
  ...
  void recv_allocate(std::vector<std::string> & _return, const int32_t seqid);
  void deallocate(const std::string& tenentID, const std::vector<std::string> & blocks);
  int32_t send_deallocate(const std::string& tenentID, const std::vector<std::string> & blocks);
