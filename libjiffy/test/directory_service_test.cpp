...
TEST_CASE("rpc_path_flush_test", "[file][dir]") {
  ...
  REQUIRE(sm->COMMANDS[0] == "setup_block:0:testtype:0_65536::/sandbox/abcdef/example/a/b:0:nil");
  REQUIRE(sm->COMMANDS[1] == "setup_block:1:testtype:0_65536::/sandbox/abcdef/example/c:0:nil");
