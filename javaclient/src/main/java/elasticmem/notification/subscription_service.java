...
public class subscription_service {
  ...
  public interface Iface {
    ...
    public void success(response_type type, java.util.List<java.lang.String> ops) throws org.apache.thrift.TException;

    public void error(response_type type, java.lang.String msg) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void success(response_type type, java.util.List<java.lang.String> ops, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void error(response_type type, java.lang.String msg, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void success(response_type type, java.util.List<java.lang.String> ops) throws org.apache.thrift.TException
    {
      sendSuccess(type, ops);
    }

    public void sendSuccess(response_type type, java.util.List<java.lang.String> ops) throws org.apache.thrift.TException
    {
      success_args args = new success_args();
      args.setType(type);
      args.setOps(ops);
      sendBaseOneway("success", args);
    }
    ...
    public void sendError(response_type type, java.lang.String msg) throws org.apache.thrift.TException
    {
      error_args args = new error_args();
      args.setType(type);
      args.setMsg(msg);
      sendBaseOneway("error", args);
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void success(response_type type, java.util.List<java.lang.String> ops, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      success_call method_call = new success_call(type, ops, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class success_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private response_type type;
      private java.util.List<java.lang.String> ops;
      public success_call(response_type type, java.util.List<java.lang.String> ops, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.type = type;
        this.ops = ops;
      }
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("success", org.apache.thrift.protocol.TMessageType.ONEWAY, 0));
        success_args args = new success_args();
        args.setType(type);
        args.setOps(ops);
        args.write(prot);
    ...
    public void error(response_type type, java.lang.String msg, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      error_call method_call = new error_call(type, msg, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class error_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private response_type type;
      private java.lang.String msg;
      public error_call(response_type type, java.lang.String msg, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.type = type;
        this.msg = msg;
      }
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("error", org.apache.thrift.protocol.TMessageType.ONEWAY, 0));
        error_args args = new error_args();
        args.setType(type);
        args.setMsg(msg);
        args.write(prot);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class success<I extends Iface> extends org.apache.thrift.ProcessFunction<I, success_args> {
      ...
      public org.apache.thrift.TBase getResult(I iface, success_args args) throws org.apache.thrift.TException {
        iface.success(args.type, args.ops);
        return null;
      }
    }

    public static class error<I extends Iface> extends org.apache.thrift.ProcessFunction<I, error_args> {
      public error() {
        super("error");
      }

      public error_args getEmptyArgsInstance() {
      ...
      public org.apache.thrift.TBase getResult(I iface, error_args args) throws org.apache.thrift.TException {
        iface.error(args.type, args.msg);
        return null;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class success<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, success_args, Void> {
      public success() {
        super("success");
      }
      ...
      public void start(I iface, success_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.success(args.type, args.ops,resultHandler);
      }
    }

    public static class error<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, error_args, Void> {
      public error() {
        super("error");
      }
      ...
      public void start(I iface, error_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.error(args.type, args.msg,resultHandler);
      }
    }
  ...
  public static class success_args implements org.apache.thrift.TBase<success_args, success_args._Fields>, java.io.Serializable, Cloneable, Comparable<success_args>   {
     ...
     * @see response_type
     */
    public success_args setType(response_type type) {
      this.type = type;
      return this;
    }
    ...
    public success_args setOps(java.util.List<java.lang.String> ops) {
      this.ops = ops;
      return this;
    }
          ...
          switch (schemeField.id) {
            case 1: // TYPE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.type = elasticmem.notification.response_type.findByValue(iprot.readI32());
  ...
  public static class error_args implements org.apache.thrift.TBase<error_args, error_args._Fields>, java.io.Serializable, Cloneable, Comparable<error_args>   {
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new error_argsStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new error_argsTupleSchemeFactory();
     ...
     * @see response_type
     */
    public error_args setType(response_type type) {
      this.type = type;
      return this;
    }
    ...
    public error_args setMsg(java.lang.String msg) {
      this.msg = msg;
      return this;
    }
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("error_args(");
      boolean first = true;
    ...
    private static class error_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public error_argsStandardScheme getScheme() {
        return new error_argsStandardScheme();
      }
    }

    private static class error_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<error_args> {
    ...
    private static class error_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public error_argsTupleScheme getScheme() {
        return new error_argsTupleScheme();
      }
    }

    private static class error_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<error_args> {
