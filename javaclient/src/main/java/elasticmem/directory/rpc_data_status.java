...
public class rpc_data_status implements org.apache.thrift.TBase<rpc_data_status, rpc_data_status._Fields>, java.io.Serializable, Cloneable, Comparable<rpc_data_status> {
  ...
  public java.util.List<rpc_block_chain> data_blocks; // required
  ...
  public rpc_data_status(
    ...
    int chain_length,
    java.util.List<rpc_block_chain> data_blocks)
  {
    this();
  ...
  public rpc_data_status(rpc_data_status other) {
    ...
    if (other.isSetDataBlocks()) {
      java.util.List<rpc_block_chain> __this__data_blocks = new java.util.ArrayList<rpc_block_chain>(other.data_blocks.size());
      for (rpc_block_chain other_element : other.data_blocks) {
        __this__data_blocks.add(new rpc_block_chain(other_element));
      }
  ...
  public java.util.Iterator<rpc_block_chain> getDataBlocksIterator() {
    return (this.data_blocks == null) ? null : this.data_blocks.iterator();
  }

  public void addToDataBlocks(rpc_block_chain elem) {
    if (this.data_blocks == null) {
      this.data_blocks = new java.util.ArrayList<rpc_block_chain>();
    }
    this.data_blocks.add(elem);
  }

  public java.util.List<rpc_block_chain> getDataBlocks() {
    return this.data_blocks;
  }

  public rpc_data_status setDataBlocks(java.util.List<rpc_block_chain> data_blocks) {
    this.data_blocks = data_blocks;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case DATA_BLOCKS:
      if (value == null) {
        ...
        setDataBlocks((java.util.List<rpc_block_chain>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // STORAGE_MODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.storage_mode = elasticmem.directory.rpc_storage_mode.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data_blocks = new java.util.ArrayList<rpc_block_chain>(_list8.size);
                rpc_block_chain _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new rpc_block_chain();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, rpc_data_status struct) throws org.apache.thrift.TException {
      ...
      if (struct.data_blocks != null) {
        oprot.writeFieldBegin(DATA_BLOCKS_FIELD_DESC);
        {
          ...
          for (rpc_block_chain _iter11 : struct.data_blocks)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class rpc_data_statusTupleScheme extends org.apache.thrift.scheme.TupleScheme<rpc_data_status> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, rpc_data_status struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.chain_length);
      {
        ...
        for (rpc_block_chain _iter12 : struct.data_blocks)
        {
          _iter12.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, rpc_data_status struct) throws org.apache.thrift.TException {
      ...
      struct.setChainLengthIsSet(true);
      {
        ...
        struct.data_blocks = new java.util.ArrayList<rpc_block_chain>(_list13.size);
        rpc_block_chain _elem14;
        for (int _i15 = 0; _i15 < _list13.size; ++_i15)
        {
          _elem14 = new rpc_block_chain();
          _elem14.read(iprot);
