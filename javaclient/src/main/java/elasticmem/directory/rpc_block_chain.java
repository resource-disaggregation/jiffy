...
public class rpc_block_chain implements org.apache.thrift.TBase<rpc_block_chain, rpc_block_chain._Fields>, java.io.Serializable, Cloneable, Comparable<rpc_block_chain> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("rpc_block_chain");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new rpc_block_chainStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new rpc_block_chainTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(rpc_block_chain.class, metaDataMap);
  }

  public rpc_block_chain() {
  }
   ...
   */
  public rpc_block_chain(rpc_block_chain other) {
  ...
  public rpc_block_chain deepCopy() {
    return new rpc_block_chain(this);
  }
  ...
  public rpc_block_chain setBlockNames(java.util.List<java.lang.String> block_names) {
    this.block_names = block_names;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof rpc_block_chain)
      return this.equals((rpc_block_chain)that);
    return false;
  }

  public boolean equals(rpc_block_chain that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(rpc_block_chain other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("rpc_block_chain(");
    boolean first = true;
  ...
  private static class rpc_block_chainStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public rpc_block_chainStandardScheme getScheme() {
      return new rpc_block_chainStandardScheme();
    }
  }

  private static class rpc_block_chainStandardScheme extends org.apache.thrift.scheme.StandardScheme<rpc_block_chain> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, rpc_block_chain struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, rpc_block_chain struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class rpc_block_chainTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public rpc_block_chainTupleScheme getScheme() {
      return new rpc_block_chainTupleScheme();
    }
  }

  private static class rpc_block_chainTupleScheme extends org.apache.thrift.scheme.TupleScheme<rpc_block_chain> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, rpc_block_chain struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, rpc_block_chain struct) throws org.apache.thrift.TException {
