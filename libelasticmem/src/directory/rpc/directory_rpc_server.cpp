#include "directory_rpc_server.h"
...
std::shared_ptr<TThreadedServer> directory_rpc_server::create(std::shared_ptr<directory_tree> shard,
  ...
  std::shared_ptr<directory_rpc_serviceProcessorFactory>
      proc_factory(new directory_rpc_serviceProcessorFactory(clone_factory));
