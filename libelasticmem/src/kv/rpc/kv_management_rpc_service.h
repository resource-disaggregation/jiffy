...
class kv_management_rpc_serviceIfSingletonFactory : virtual public kv_management_rpc_serviceIfFactory {
 public:
  kv_management_rpc_serviceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<kv_management_rpc_serviceIf> &iface)
      : iface_(iface) {}
...
class kv_management_rpc_serviceNull : virtual public kv_management_rpc_serviceIf {
 public:
  ...
  void flush(const int32_t /* block_id */,
             const std::string & /* persistent_store_prefix */,
             const std::string & /* path */) {
    return;
  }
  void load(const int32_t /* block_id */,
            const std::string & /* persistent_store_prefix */,
            const std::string & /* path */) {
    return;
  }
...
class kv_management_rpc_serviceClientT : virtual public kv_management_rpc_serviceIf {
 public:
  ...
  kv_management_rpc_serviceClientT(apache::thrift::stdcxx::shared_ptr<Protocol_> iprot,
...
class kv_management_rpc_serviceProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 protected:
  ...
  virtual bool dispatchCallTemplated(Protocol_ *iprot,
                                     ...
                                     void *callContext);
 private:
  typedef void(kv_management_rpc_serviceProcessorT::*ProcessFunction)
      (int32_t, ::apache::thrift::protocol::TProtocol *, ::apache::thrift::protocol::TProtocol *, void *);
  typedef void
  (kv_management_rpc_serviceProcessorT::*SpecializedProcessFunction)(int32_t, Protocol_ *, Protocol_ *, void *);
...
typedef kv_management_rpc_serviceProcessorT<::apache::thrift::protocol::TDummyProtocol>
    kv_management_rpc_serviceProcessor;

template<class Protocol_>
class kv_management_rpc_serviceProcessorFactoryT : public ::apache::thrift::TProcessorFactory {
 public:
  kv_management_rpc_serviceProcessorFactoryT(const ::apache::thrift::stdcxx::shared_ptr<
      kv_management_rpc_serviceIfFactory> &handlerFactory) :
...
typedef kv_management_rpc_serviceProcessorFactoryT<::apache::thrift::protocol::TDummyProtocol>
    kv_management_rpc_serviceProcessorFactory;

class kv_management_rpc_serviceMultiface : virtual public kv_management_rpc_serviceIf {
 public:
  kv_management_rpc_serviceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<kv_management_rpc_serviceIf> > &ifaces)
      : ifaces_(ifaces) {
  }
...
class kv_management_rpc_serviceConcurrentClientT : virtual public kv_management_rpc_serviceIf {
 public:
  ...
  kv_management_rpc_serviceConcurrentClientT(apache::thrift::stdcxx::shared_ptr<Protocol_> iprot,
                                             apache::thrift::stdcxx::shared_ptr<Protocol_> oprot) {
    setProtocolT(iprot, oprot);
  }
 private:
...
typedef kv_management_rpc_serviceConcurrentClientT<::apache::thrift::protocol::TProtocol>
    kv_management_rpc_serviceConcurrentClient;
