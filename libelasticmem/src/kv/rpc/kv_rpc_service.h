...
class kv_rpc_serviceIfSingletonFactory : virtual public kv_rpc_serviceIfFactory {
 public:
  kv_rpc_serviceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<kv_rpc_serviceIf> &iface)
      : iface_(iface) {}
...
class kv_rpc_serviceClientT : virtual public kv_rpc_serviceIf {
 public:
  ...
  kv_rpc_serviceClientT(apache::thrift::stdcxx::shared_ptr<Protocol_> iprot,
...
class kv_rpc_serviceProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 protected:
  ...
  virtual bool dispatchCallTemplated(Protocol_ *iprot,
                                     ...
                                     void *callContext);
 private:
  typedef void(kv_rpc_serviceProcessorT::*ProcessFunction)
  ...
  void process_put(int32_t seqid,
  ...
  void process_update(int32_t seqid,
                      ::apache::thrift::protocol::TProtocol *iprot,
                      ::apache::thrift::protocol::TProtocol *oprot,
                      void *callContext);
  ...
  void process_size(int32_t seqid,
                    ::apache::thrift::protocol::TProtocol *iprot,
                    ::apache::thrift::protocol::TProtocol *oprot,
                    void *callContext);
...
class kv_rpc_serviceMultiface : virtual public kv_rpc_serviceIf {
 public:
  kv_rpc_serviceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<kv_rpc_serviceIf> > &ifaces)
      : ifaces_(ifaces) {
  }
...
class kv_rpc_serviceConcurrentClientT : virtual public kv_rpc_serviceIf {
 public:
  ...
  kv_rpc_serviceConcurrentClientT(apache::thrift::stdcxx::shared_ptr<Protocol_> iprot,
                                  apache::thrift::stdcxx::shared_ptr<Protocol_> oprot) {
    setProtocolT(iprot, oprot);
  }
 private:
