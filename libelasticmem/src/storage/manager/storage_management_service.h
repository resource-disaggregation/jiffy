...
class storage_management_serviceIf {
 public:
  ...
  virtual void setup_block(const int32_t block_id, const std::string& path, const int32_t chain_role, const std::string& next_block_name) = 0;
...
class storage_management_serviceNull : virtual public storage_management_serviceIf {
 public:
  ...
  void setup_block(const int32_t /* block_id */, const std::string& /* path */, const int32_t /* chain_role */, const std::string& /* next_block_name */) {
    return;
  }
...
typedef struct _storage_management_service_setup_block_args__isset {
  _storage_management_service_setup_block_args__isset() : block_id(false), path(false), chain_role(false), next_block_name(false) {}
  bool block_id :1;
  bool path :1;
  bool chain_role :1;
...
class storage_management_service_setup_block_args {
 public:
  ...
  storage_management_service_setup_block_args() : block_id(0), path(), chain_role(0), next_block_name() {
  }
...
class storage_management_serviceClientT : virtual public storage_management_serviceIf {
 ...
 public:
  ...
  void setup_block(const int32_t block_id, const std::string& path, const int32_t chain_role, const std::string& next_block_name);
  void send_setup_block(const int32_t block_id, const std::string& path, const int32_t chain_role, const std::string& next_block_name);
...
class storage_management_serviceMultiface : virtual public storage_management_serviceIf {
 ...
 public:
  void setup_block(const int32_t block_id, const std::string& path, const int32_t chain_role, const std::string& next_block_name) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->setup_block(block_id, path, chain_role, next_block_name);
    }
    ifaces_[i]->setup_block(block_id, path, chain_role, next_block_name);
  }
...
class storage_management_serviceConcurrentClientT : virtual public storage_management_serviceIf {
 ...
 public:
  ...
  void setup_block(const int32_t block_id, const std::string& path, const int32_t chain_role, const std::string& next_block_name);
  int32_t send_setup_block(const int32_t block_id, const std::string& path, const int32_t chain_role, const std::string& next_block_name);
